...
export default function OnboardingScreen({ onComplete }) {
  ...
  // Was free TextInput for both — replaced with chip selectors below, so
  // these now hold a real value/string from a fixed set instead of
  // whatever the user happened to type ("2nd year", "secondo", "II"...).
      ...
      >
        ...
        {step === 2 && (
          <View style={styles.stepBlock}>
            ...
            {/* Was a free-text "Year (e.g. 2nd)" field — replaced with a
                fixed 1-5 chip row, since anything typed there was never
                actually parsed into a number anywhere downstream. */}
            ...
            {/* Was a free-text "Total credits of your plan (e.g. 180)"
                numeric field — replaced with the three real Italian degree
                types, since 180/120/300 are the only values that actually
                make sense here and typing a number gave no guidance. */}
